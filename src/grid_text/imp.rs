...
#[template(resource = "/org/caioxcezar/packagemanager/grid_text.ui")]
pub struct GridText {
    #[template_child]
...
impl ObjectSubclass for GridText {
    const NAME: &'static str = "GridText";
    type Type = super::GridText;
...
impl ObjectImpl for GridText {
    fn dispose(&self) {
        self.dispose_template();
    }
}
impl WidgetImpl for GridText {}
