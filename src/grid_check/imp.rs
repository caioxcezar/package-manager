...
#[template(resource = "/org/caioxcezar/packagemanager/grid_check.ui")]
...
impl ObjectSubclass for GridCheck {
    const NAME: &'static str = "GridCheck";
    type Type = super::GridCheck;
...
impl ObjectImpl for GridCheck {
    fn dispose(&self) {
        self.dispose_template();
    }
}
impl WidgetImpl for GridCheck {}
